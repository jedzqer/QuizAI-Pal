...
export const aiApi = {
  ...
  startComprehensiveLecture: (wrongQuestionIds: number[], topic: string, callbacks: StreamCallbacks) =>
    fetchStream('/api/ai/lecture/comprehensive', { wrong_question_ids: wrongQuestionIds, topic }, callbacks),
